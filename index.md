...
Techniques like SMOTE and random undersampling were employed to address class imbalance, followed by training of predictive models including Support Vector Machine (SVM), Decision Tree (DT), Naive Bayes (NB), Random Forest (RF) and Logistic Regression (LR) using SAS Enterprise Miner.   
Analysis revealed RF outperformed other models with the highest accuracy, precision, recall and F1-score. 
